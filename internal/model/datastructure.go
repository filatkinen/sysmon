...
var StampNameHeaders = []NameHeader{
	...
	{Name: "DisksUsage",
		Header:          append([]string(nil), "Mount Point", "File System", "Usage Inodes", "Usage Inode Percent", "Usage Mb", "Usage Mb Percent"),
		SortHeaderField: 0,
		SortDescending:  false,
	},
	{Name: "NetworkListen",
...
// DataElement :
//
//  1. Represents the states of one slice queried params
//  2. Save calculated average params for clients
//type DataElement struct {
//	LoadAvg           DataLoadAvg
//	CpuAvgStats       DataCpuAvgStats
//	DisksLoad         []DataDisksLoad
//	DisksUsage        []DataDisksUsage
//	NetworkListen     []DataNetworkListen
//	NetworkStates     []DataNetworkStates
//	TopNetworkProto   []DataTopNetworkProto
//	TopNetworkTraffic map[string][]DataTopNetworkTraffic
//}

// Data represent slices queried params
//
//	Elements  - map of DataElement
//	Index - slice of index to map
//	MaxElements - max elements in map
